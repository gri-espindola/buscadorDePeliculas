...
const DetallePopulares =()=>{
    ...
    useEffect(()=> {
        fetch(`https://api.themoviedb.org/3/movie/${params.idDetallesPopulares}?api_key=07b7fbf0aa198d742f7f3020308675d2&language=es`)
        .then(res=> res.json())
        .then(data => { 
        setDetalle(data);
    });
...
export default DetallePopulares